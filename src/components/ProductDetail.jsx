...
function ProductDetail({ setProductCount, setCurrentPage, productCount }) {
  ...
  const submitData = () => {
    const productSelected = {
      id: params.id,
      colorCode:
        details.options.colors.length === 1
          ? Number(details.options.colors[0].code)
          : Number(selectedColor),
      storageCode:
        details.options.storages.length === 1
          ? Number(details.options.storages[0].code)
          : Number(selectedStorage),
    };
        ...
        <article className="productDetails">
          <div className="productDetails--header">
            ...
            <Link
              ...
              className="productDetails--header__link"
            >
              Volver atrás
            </Link>
          </div>
          ...
          <section className="productDetails--section">
            <img
              ...
              className="productDetails--section__img"
            />
            <div className="productDetails--section__details">
              ...
              <ul className="details--list">
                ...
                <li>
                  <b>Modelo:</b> {details.model}
                </li>
                <li>
                  <b>Precio:</b> {details.price}€
                </li>
                <li>
                  <b>CPU:</b> {details.cpu}
                </li>
                ...
                <li>
                  <b>Sistema operativo:</b> {details.os}
                </li>
                <li>
                  <b>Resolución de pantalla:</b> {details.displayResolution}
                </li>
                <li>
                  <b>Batería:</b> {details.battery}
                </li>
                <li>
                  <b>Cámaras:</b> {details.primaryCamera}
                  <br />
                  {details.secondaryCmera}
                </li>
                <li>
                  <b>Dimensiones:</b> {details.dimentions}
                </li>
                <li>
                  <b>Peso:</b>{' '}
                  {details.weight !== '' ? details.weight : 'No especificado'}
                </li>
              </ul>
                ...
                <div className="personalization--items">
                  <div className="personalization--form">
                    ...
                    <select
                      ...
                      defaultValue={
                        details.options.storages.length === 1
                          ? details.options.storages[0].code
                          : null
                      }
                      onChange={handleStorageChange}
                    >
                      {details.options.storages.map((option) => (
                  ...
                  <div className="personalization--form">
                    ...
                    <select
                      ...
                      defaultValue={
                        details.options.colors.length === 1
                          ? details.options.colors[0].code
                          : null
                      }
                      onChange={handleColorsChange}
                    >
                      {details.options.colors.map((option) => (
                        <option key={option.code} value={option.code}>
                          {option.name}
                        </option>
                      ))}
